...
<body>
    ...
    <div class="container">
        <!--first section-->
        <section class="1st" id="first-section">
            <aside class="aside">
            ...
            <article>
                ...
                <form action="#1st_section" method="POST" name="form" class="form-element">
        ...
        <section class="2nd" id="second-section">
          <aside class="aside">
    ...
    <article>
        ...
        <form action="#2nd_section" method="POST" enctype="multipart/form-data" class="form-element" name="form">
            <div>
        ...
        <hr>
        <section class="#3rd" id="third-section">
            <aside class="aside">
                <h2><i class="fa fa-question">Info</i></h2>
                <ul>
                    <li>method:POST</li>
            ...
            <article>
                ...
                <form action="#3rd_section" method="POST" name="form" class="form-element">
